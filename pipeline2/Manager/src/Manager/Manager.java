    ...
    private RC SET_STREAM_OUTPUT(){
        ...
        */
        try {
            ...
            String name_writer = (String) CONFIG.get(CONFIG_GRAMMAR[config.WRITER_CLASS.param]).get_array()[0].get_array()[0].get_array()[0].get_KEY();
            return WRITE.setConfig((String) CONFIG.get(CONFIG_GRAMMAR[config.CONFIG.param]).Search(name_writer).get_array()[0].get_KEY());
        }catch (FileNotFoundException e){
